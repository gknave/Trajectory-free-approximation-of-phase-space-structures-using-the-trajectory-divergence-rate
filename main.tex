...
\begin{minipage}{0.45\textwidth}
\centering
\includegraphics[height=2.8in]{Figures/RepRate_saddle.eps}
\end{minipage}
...
\begin{minipage}{3.2in}
\centering
\includegraphics[width=3.2in]{Figures/RepRate_rotating-hoop.eps}
\end{minipage}
\begin{minipage}{3.2in}
\centering
\includegraphics[width=3.2in]{Figures/RepRatio_rotating-hoop.eps}
\end{minipage}
...
%		\includegraphics{Figures/rho-dot-field-zoom.eps}
...
\begin{figure*}
\centering
\includegraphics[width=\linewidth]{Figures/MSEAScomp.eps}
...
\begin{figure*}
	\centering
	\includegraphics[width=0.85\linewidth]{Figures/div-rate-3d-figure.eps}
